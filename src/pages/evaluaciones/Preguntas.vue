...
export default {
    ...
    data () {
        return {
            ...
            headers: [
                ...
                { text: 'CLA', value: 'cla', sortable: false },
    ...
    computed: {
        ...
        url () {
            let url = this.editedIndex === -1 ? '/preguntas' : `/preguntas/${this.id_pregunta}`
            return url
        },
    },
    watch: {
    ...
    methods: {
        ...
        async readDataFromAPI() {
            ...
            if (userLogged) {
                ...
                let response = await api.call_respuesta_directa('/preguntas') 
            ...
            let response = await api.call_respuesta_directa(`/subdimensiones/select/all`) 
            response = response.data ? response.data.data : this.subdimensiones
            this.subdimensiones = response
        ...
        async processExcelPreguntas(preguntas) {
            ...
            if (userLogged) {
                ...
                response = await api.call_respuesta_directa(`/preguntas/procesar/test/${this._id_test}`) 
            }
        ...
        async deleteApi() {
            ...
            if (userLogged) {
                ...
                response = await api.call_respuesta_directa(`/preguntas/${this.id_pregunta}`) 
            }
