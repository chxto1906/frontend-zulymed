<template>
    <div class="sticky top-0 z-40">
            <div class="w-full h-8 px-12  border-b flex items-center justify-between" :style="{background: system.colores.fondo_principal}">
              ...
              <div class="flex">
                ...
                <div class="inline-block lg:hidden flex items-center mr-4">
                  <button class=" hover:border-white focus:outline-none navbar-burger" @click="toggleSidebar()">
              ...
              <div class="flex items-center relative">
                ...
                <img src="https://a7sas.net/wp-content/uploads/2019/07/4060.jpeg" class="cursor-pointer w-6 h-6 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
              </div>
            ...
            <div class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 bottom-10 right-0 mr-6" :class="dropDownOpen ? '' : 'hidden'">
                <a href="#" @click="logout" class="block px-4 py-2 hover:bg-gray-200">Cerrar sesión</a>
            </div>
            <!-- dropdown menu end -->
